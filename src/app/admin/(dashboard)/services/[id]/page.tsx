...
export default function ServiceEditPage() {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold mb-6">{isNew ? 'Add Service' : 'Edit Service'}</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            {(['mn', 'en'] as const).map((l) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                  locale === l ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                }`}
              >
                {l === 'mn' ? 'Монгол' : 'English'}
              </button>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Description ({locale.toUpperCase()})</label>
              <textarea
